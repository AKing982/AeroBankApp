package com.example.aerobankapp.messages;
...
public class CommonLabels
{
    ...
    public static final String AEROBANK = "AeroBank";
    public static final String ADD_ACCOUNTS = "Add Accounts";
    ...
    public static final String IS_USER_ADMIN = "Is this User an Admin? ";
