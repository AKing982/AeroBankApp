...
class PlaidTransactionImporterImplTest {
    ...
    void setUp() {
        ...
        plaidTransactionImporter = new PlaidTransactionImporterImpl(converter, plaidTransactionService, plaidLinkService, transactionCriteriaService, transactionStatementService,  externalAccountsService, plaidTransactionManager);
    }
